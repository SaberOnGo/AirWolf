...
#define   SW_UART2_RX_PIN                    GPIO_Pin_0
#define   SW_UART2_RX_PORT               GPIOA
#define   GPIO_PortSource_SW_UART2_RX             GPIO_PortSourceGPIOA
#define   GPIO_PinSource_SW_UART2_RX                GPIO_PinSource0
#define    EXTI_Line_SW_UART2_RX                              EXTI_Line0
#define    EXTI_SW_UART2_RX_IRQn                           EXTI0_IRQn
#define    EXTI_SW_UART2_RX_IRQHandler             EXTI0_IRQHandler
