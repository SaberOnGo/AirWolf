...
#define PRINT_SELECT    UART_BLOCK //UART_QUEUE
...
#define  GIZ_UART_SEL     UART_BLOCK //UART_QUEUE    // 队列式输出
...
#define UGUI_USE_FONT  1 //FONT_IN_SPI_FLASH
...
typedef enum
{
       NET_SEL_WIFI  = 0,   // wifi
       NET_SEL_GPRS  = 1,  // GPRS
       NET_SEL_None   = 2,  // close WIFI & GRPS
       NET_SEL_END,
}E_NET_SEL;

typedef enum
{
         NET_STA_UnConn  = 0,     // 未连接
         NET_STA_OnConn  = 1,    // 连接中
         NET_STA_Conn       = 2,      // 已连接
         NET_STA_NoResp   = 3,    // 无响应
}E_NET_STA;
