...
#define KEY_MASK    0x07 //0x03    // 只有2个按键, bit1-bit0
#define NO_KEY          0x07 //0x03   // 

#define KEY_0              0x06   // 110, BIT0 == 0
#define KEY_1              0x05   // 101, BIT1 == 0
#define KEY_2              0x03   // 011, BIT2 == 0

#define FUNC_KEY    KEY_0
#define NEXT_KEY    KEY_1
#define PWR_KEY     KEY_2    // power on / off key
