...
#define   GPIO_PinSource_SW_UART1_RX                 GPIO_PinSource0
#define    EXTI_Line_SW_UART1_RX                              EXTI_Line0
#define    EXTI_SW_UART3_RX_IRQn                           EXTI0_IRQn

#define    EXTI_SW_UART3_RX_IRQHandler             EXTI0_IRQHandler
